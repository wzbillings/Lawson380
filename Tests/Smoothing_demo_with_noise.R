...
ridge1_2p_wn <- model_logistic_data_smoothing(prep_2p_wn, 0.001)
cat("Smoothing = 0.1; 4% noise\n")
ridge2_2p_wn <- model_logistic_data_smoothing(prep_2p_wn, 0.1)
cat("Smoothing = 1; 4% noise\n")
ridge2_2p_wn <- model_logistic_data_smoothing(prep_2p_wn, 1)
cat("Smoothing = 10; 4% noise\n")
ridge2_2p_wn <- model_logistic_data_smoothing(prep_2p_wn, 10)
cat("Smoothing = 15; 4% noise\n")
ridge2_2p_wn <- model_logistic_data_smoothing(prep_2p_wn, 15)
